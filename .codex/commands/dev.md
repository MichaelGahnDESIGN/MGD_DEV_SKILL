...
Nutze `dev/SKILL.md` aus diesem Repository als Arbeitsgrundlage und führe den Ablauf in dieser Reihenfolge durch:

1. Projektkontext und Regeln laden (`AGENTS.md`, `README.md`, `docs/` usw.)
